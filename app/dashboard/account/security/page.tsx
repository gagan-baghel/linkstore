  ...
  return (
    <DashboardShell>
      <DashboardHeader
        ...
        text="Manage password, recovery, and account protection from Clerk."
      />
      <div className="space-y-4">
        <div className="rounded-xl border border-[#d8e2f3] bg-white p-4">
          <p className="text-sm text-[#4f5f7a]">
            Forgot your password? Open the reset flow directly from sign-in.
          </p>
          <div className="mt-3">
            <Link href="/auth/login/forgot-password">
              <Button variant="outline" className="h-9 border-[#cfd8ea] bg-white text-xs text-[#1f2a44] hover:bg-[#f3f6fc] sm:text-sm">
                Forgot Password
              </Button>
            </Link>
          </div>
