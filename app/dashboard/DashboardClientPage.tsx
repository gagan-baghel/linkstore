...
export default function DashboardClientPage({
  ...
  useEffect(() => {
    if (panelParam || !activeSetupPanel) return
    const params = new URLSearchParams(searchParams.toString())
    params.set("panel", activeSetupPanel)
    router.replace(`${pathname}?${params.toString()}`, { scroll: false })
  }, [panelParam, activeSetupPanel, pathname, router, searchParams])
        ...
        return (
          <div className="dashboard-quick-setup space-y-5">
            <div className="min-w-0 space-y-5">
              <div>
                <h4 className="mb-1 text-base font-semibold text-slate-900">Social links</h4>
                <p className="text-sm text-slate-500">Add the links you want visible on your store.</p>
              </div>
              <SocialLinksForm
              ...
              <Button
                ...
                asChild
              >
                <a href={socialLinksHref}>Open links settings</a>
              </Button>
              {/* <Link href={socialLinksHref} className="inline-flex text-sm font-medium text-primary hover:underline">
                Manage all links →
              </Link> */}
            </div>
  ...
  return (
    <DashboardShell>
      ...
      <section className="mb-8 grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-start">
        <div className="space-y-6 lg:max-h-[calc(100vh-160px)] lg:overflow-y-auto lg:pr-2">
          ...
          <Card className="rounded-3xl border-slate-200/70 bg-white/85 shadow-[0_18px_44px_rgba(15,23,42,0.08)] backdrop-blur">
            <CardHeader className="space-y-4">
              <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <CardTitle className="text-lg text-slate-900 sm:text-xl">Set up in minutes</CardTitle>
                  {/* <CardDescription className="text-slate-500">
                    Link your socials, add products, and style your storefront.
                  </CardDescription> */}
                </div>
                <div className="min-w-[180px] rounded-2xl border border-slate-200/80 bg-white px-4 py-3 shadow-[0_12px_30px_rgba(15,23,42,0.06)]">
              ...
              <div className="flex flex-wrap gap-2 rounded-full border border-slate-200/80 bg-slate-50 p-1">
                {([
                  { id: "links", label: "Links" },
                  { id: "products", label: "Add products" },
                  { id: "design", label: "Settings" },
            ...
            <CardContent>{renderSetupPanel()}</CardContent>
          </Card>
        </div>
