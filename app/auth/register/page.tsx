...
export default function RegisterPage() {
  return (
    <div className="relative min-h-screen overflow-hidden">
      <div className="pointer-events-none absolute -left-20 top-20 h-64 w-64 rounded-full bg-sky-300/25 blur-3xl dark:bg-sky-500/15" />
      <div className="pointer-events-none absolute right-0 top-28 h-72 w-72 rounded-full bg-violet-300/30 blur-3xl dark:bg-violet-500/20" />

      <div className="container flex min-h-screen items-center py-8 md:py-12">
